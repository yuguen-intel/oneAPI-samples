...
`icpx -sycl -fintelfpga -DFPGA_EMULATOR fpga_compile.cpp -o fpga_compile.fpga_emu`

**Optimization report (default board)**

`icpx -sycl -fintelfpga -Xshardware -fsycl-link=early fpga_compile.cpp -o fpga_compile_report.a`

**Optimization report (explicit board)**

`icpx -sycl -fintelfpga -Xshardware -fsycl-link=early -Xsboard=intel_s10sx_pac:pac_s10 fpga_compile.cpp -o fpga_compile_report.a`

**FPGA hardware (default board)**

`icpx -sycl -fintelfpga -Xshardware fpga_compile.cpp -o fpga_compile.fpga`

**FPGA hardware (explicit board)**

`icpx -sycl -fintelfpga -Xshardware -Xsboard=intel_s10sx_pac:pac_s10 fpga_compile.cpp -o fpga_compile.fpga`
